...
```shell
CUSTOM_TEMPLATES_DIRECTORY="/var/lib/antimage/templates/"
```
...
```shell
mkdir /var/lib/antimage/templates/sing-box
```
...
```
Now, restart your AntiMage and enjoy.

If you have already changed your env variables, and you want to just update the template files, there is no need to restart AntiMage.
