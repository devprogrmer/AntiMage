...
func printUsage() {
	fmt.Println("Usage: antimage cli <command> [options]")
	fmt.Println()
...
func printAdminUsage() {
	fmt.Println("Usage: antimage cli admin <command> [options]")
	fmt.Println()
	fmt.Println("Commands:")
...
func printUserUsage() {
	fmt.Println("Usage: antimage cli user <command> [options]")
	fmt.Println("Commands: list, set-owner")
}

func printSubscriptionUsage() {
	fmt.Println("Usage: antimage cli subscription <command> [options]")
	fmt.Println("Commands: get-link, get-config")
}

func printMigrateUsage() {
	fmt.Println("Usage: antimage migrate <command>")
