...
type V2rayNShadowsocksProfile struct {
	...
	CipherSuites         string                          `json:"CipherSuites,omitempty"` // AntiMage/xray-json extension.
...
type V2rayNShadowsocksTransportExtra struct {
	...
	KCPTTI        int    `json:"KcpTti,omitempty"`          // AntiMage/xray-json extension.
	Heartbeat     int    `json:"HeartbeatPeriod,omitempty"` // AntiMage/xray-json extension.
}
...
// existing Xray-aware SS URL representation used only inside AntiMage.
