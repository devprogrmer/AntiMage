...
ANTIMAGE_NODE_SCRIPT_SOURCE_FILE="${ANTIMAGE_NODE_SCRIPT_SOURCE_FILE:-antimage-node.sh}"

SCRIPT_NAME=$(basename "$0")
SCRIPT_BASENAME="${SCRIPT_NAME%.*}"
SCRIPT_DEFAULT_APP_NAME="${ANTIMAGE_NODE_DEFAULT_APP_NAME:-$SCRIPT_BASENAME}"
case "$SCRIPT_DEFAULT_APP_NAME" in
    antimage-node-binary|@|bash|sh)
        SCRIPT_DEFAULT_APP_NAME="antimage-node"
    ;;
esac
...
ANTIMAGE_NODE_RELEASE_REPO="${ANTIMAGE_NODE_RELEASE_REPO:-antimagepanel/antimage-node}"
