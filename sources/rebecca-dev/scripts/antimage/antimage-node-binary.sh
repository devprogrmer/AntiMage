...
ANTIMAGE_NODE_SCRIPT_SOURCE_FILE="${ANTIMAGE_NODE_SCRIPT_SOURCE_FILE:-rebecca-node-binary.sh}"

SCRIPT_DEFAULT_APP_NAME="${ANTIMAGE_NODE_DEFAULT_APP_NAME:-rebecca-node}"
