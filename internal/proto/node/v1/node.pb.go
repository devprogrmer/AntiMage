...
const file_node_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"node.proto\x12\x10antimage.node.v1\"\a\n" +
	"\x05Empty\"R\n" +
	...
	"\n" +
	"StreamLogs\x12#.antimage.node.v1.StreamLogsRequest\x1a\x19.antimage.node.v1.LogLine0\x01B?Z=github.com/devprogrmer/AntiMage/internal/proto/node/v1;nodev1b\x06proto3"
