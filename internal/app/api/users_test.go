...
func testUserReadServer(t *testing.T) (*Server, *sql.DB) {
	...
	statements := []string{
		...
		`CREATE TABLE user_subscription_access (id INTEGER PRIMARY KEY, user_id INTEGER NOT NULL, token TEXT, credential_key TEXT, username TEXT, user_agent TEXT, created_at DATETIME NULL, updated_at DATETIME NULL)`,
