...
const (
	Format    = "antimage-backup"
	Version   = 1
	Extension = ".rbbackup"
	MediaType = "application/vnd.antimage.backup"
	...
	DisabledDetail = "AntiMage backup and import is available only on binary installations. Migrate this panel to the binary version before using backup or restore from the web UI."
)
