...
const (
	// ActiveWindow is intentionally larger than the maximum supported
	// node usage collection cadence. This covers two 30s collection
	// periods plus scheduling/network jitter and prevents users from
	// flapping Offline between successful presence refreshes.
