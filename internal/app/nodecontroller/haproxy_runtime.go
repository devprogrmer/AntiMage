...
func haproxySiteSocket(configID int64, listenerIndex, siteIndex int) string {
	return fmt.Sprintf("/tmp/antimage-haproxy-%d-%d-%d.sock", configID, listenerIndex, siteIndex)
}

func haproxyDefaultTLSSiteSocket(configID int64, listenerIndex, siteIndex int) string {
	return fmt.Sprintf("/tmp/antimage-haproxy-%d-%d-%d-tls.sock", configID, listenerIndex, siteIndex)
}
